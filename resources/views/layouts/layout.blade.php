...
<head>
    ...
    <link rel="stylesheet" href="/admin/css/lib/nv.d3.css">
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header is-small-screen">
    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <a class="mdl-navigation__link" href="{{route('member.index')}}">
                <i class="material-icons" role="presentation">person</i>
                Member
            </a>
            <a class="mdl-navigation__link" href="{{route('perusahaan.index')}}">
                <i class="material-icons" role="presentation">map</i>
                Perusahaan
            </a>
            <a class="mdl-navigation__link" href="{{route('lowongan.index')}}">
                <i class="material-icons">view_comfy</i>
                Lowongan
            </a>
            <a class="mdl-navigation__link" href="{{route('lamaran.index')}}">
                <i class="material-icons">view_comfy</i>
                Lamaran
            </a>
...
<!-- inject:js -->
<script src="/admin/js/d3.js"></script>
<script src="/admin/js/getmdl-select.min.js"></script>
<script src="/admin/js/material.js"></script>
<script src="/admin/js/nv.d3.js"></script>
<script src="/admin/js/widgets/employer-form/employer-form.js"></script>
<script src="/admin/js/widgets/line-chart/line-chart-nvd3.js"></script>
<script src="/admin/js/widgets/map/maps.js"></script>
<script src="/admin/js/widgets/pie-chart/pie-chart-nvd3.js"></script>
<script src="/admin/js/widgets/table/table.js"></script>
<script src="/admin/js/widgets/todo/todo.js"></script>
<!-- endinject -->
